    ...
    async initialize(modelId, progressCallback, config = {}) {
        ...
        this.initPromise = (async () => {
            ...
            try {
                ...
                if (error.name === 'NetworkError' || ((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes('Cache.add')) || ((_b = error.message) === null || _b === void 0 ? void 0 : _b.includes('Failed to fetch'))) {
                ...
                if (((_c = error.message) === null || _c === void 0 ? void 0 : _c.includes("Context lost")) || ((_d = error.message) === null || _d === void 0 ? void 0 : _d.includes("valid external Instance"))) {
