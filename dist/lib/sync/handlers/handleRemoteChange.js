...
export async function handleRemoteChange(driveFile, drive, storage, getRootFolderId, onProgress) {
    var _a;
    ...
    if (!isFolder) {
        ...
        if (isText) {
            ...
            try {
                ...
                onProgress === null || onProgress === void 0 ? void 0 : onProgress(`Error downloading PDF ${driveFile.name}`);
            }
