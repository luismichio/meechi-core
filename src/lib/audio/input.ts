export class AudioInputService {
  ...
  private processor: ScriptProcessorNode | null = null; // Fallback or AudioWorklet
    ...
    try {
      ...
      this.processor.onaudioprocess = (e) => {
        ...
        if (this.audioContext && this.audioContext.sampleRate !== this.SAMPLE_RATE) {
             inputData = this.downsampleBuffer(inputData, this.audioContext.sampleRate, this.SAMPLE_RATE) as any;
        }
