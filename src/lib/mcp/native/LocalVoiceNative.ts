 ...
 */
export class LocalVoiceNative implements McpConnector {
    id = "native-local-voice";
    name = "Native Local Voice (Experimental)";
    description = "Privacy-first local voice interaction using browser-based STT (Whisper) and TTS (Kokoro). Experimental.";
    isPermanent = false;
