...
import type { DeviceCapabilities } from '../lib/device/deviceDetection';
    ...
    useEffect(() => {
        const init = async () => {
            ...
            try {
                ...
                if (selectedConfig?.preConsentRequired && configModel && configModel !== 'Auto') {
                ...
                if (shouldWarnBeforeDownload(selectedConfig?.estimatedDownloadMB, capabilities) && (!configModel || configModel === 'Auto')) {
